...
export function KpiCardGrid({ kpis }: { kpis: DashboardKpis }) {
  return (
    <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
      ...
      <KpiCard icon={FolderKanban} label="Total Programs" value={formatNumber(kpis.totalPrograms)} />
      ...
      <KpiCard icon={HandCoins} label="Active Programs" value={formatCompactNumber(kpis.activePrograms)} />
    </section>
  );
}
